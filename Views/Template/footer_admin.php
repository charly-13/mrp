                ...
                <div class="p-4">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Semi caja</h5>
                        </div>
                        <!-- end col -->
                    </div>

                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Esquema de colores</h6>
                    <p class="text-muted">Elige el esquema claro u oscuro.</p>
                    ...
                    <div class="colorscheme-cardradio">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Luz</h5>
                            </div>
                    ...
                    <div id="sidebar-visibility">
                        ...
                        <p class="text-muted">Elige un diseño fluido o en caja. </p>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="<?= media(); ?>/minimal/images/sidebar/img-1.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>	
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="<?= media(); ?>/minimal/images/sidebar/img-2.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="<?= media(); ?>/minimal/images/sidebar/img-3.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="<?= media(); ?>/minimal/images/sidebar/img-4.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?= media(); ?>/minimal/libs/simplebar/simplebar.min.js"></script>
    ...
    <!-- Vector map-->
    <script src="<?= media(); ?>/minimal/libs/jsvectormap/js/jsvectormap.min.js"></script>
    <script src="<?= media(); ?>/minimal/libs/jsvectormap/maps/world-merc.js"></script>
